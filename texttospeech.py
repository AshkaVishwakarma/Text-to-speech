...
Label(root,text="VOICE",font="arial 15 bold", bg="#348feb", fg="white").place(x=580,y=160)
Label(root,text="SPPED",font="arial 15 bold", bg="#348feb", fg="white").place(x=760,y=160)
